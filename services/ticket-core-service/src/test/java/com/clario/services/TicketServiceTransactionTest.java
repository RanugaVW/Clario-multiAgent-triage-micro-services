...
class TicketServiceTransactionTest {
    ...
    void setUp() {
        ...
        dispatcher.stop();
        service = new TicketService(repository, redis, new ObjectMapper(), mock(TraceEventPublisher.class), dispatcher);
    }
    ...
    void insideATransaction_nothingIsEnqueued_untilCommit() {
        ...
        service.createTicket("help", "s", UUID.randomUUID(), null, null);
