...
public class OpenApiConfig {
    ...
    public OpenAPI clarioOpenApi() {
        return new OpenAPI()
                .info(new Info()
                        .title("Clario Agent Review Service API")
                        .version("1.0.0")
                        .description("Ticket intake and retrieval for the human-review side of the pipeline. Every endpoint requires a Supabase-issued "
