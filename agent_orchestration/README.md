...
No frontend, no API Gateway, no database wired in yet - this service is standalone and
callable directly via curl/Postman for development and testing. When Member 3's API
...
Invoke-RestMethod `
  -Method Post `
  -Uri "http://localhost:8600/process_ticket" `
  -ContentType "application/json" `
  -Body $ticket | ConvertTo-Json -Depth 20
  ```
