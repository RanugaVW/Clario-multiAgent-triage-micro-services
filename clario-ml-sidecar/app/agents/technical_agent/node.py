"""Technical specialist: retrieve context, assess relevance, then draft."""
...
async def technical_agent_node(state: TicketState) -> TicketState:
    """Write Technical context, relevance data, and a draft or None on LLM failure."""
    domain = "technical"
    try:
